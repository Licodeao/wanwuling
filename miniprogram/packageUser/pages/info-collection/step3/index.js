...
Page({
  ...
  onLoad() {
    this.storeBindings = createStoreBindings(this, {
      ...
      fields: ['userInfo'],
      actions: [
        'updateUserKnowledgeScienceAction', 'updateUserKnowledgeLanguageAction'
      ]
    })
  },
  ...
  navigateToNextPage() {
    const hasSelectedScience = this.data.scienceChecks.some(item => item.checked)
    const hasSelectedLanguage = this.data.languageChecks.some(item => item.checked)
    ...
    const selectedScience = this.data.scienceChecks.filter(item => item.checked)
    const selectedLanguage = this.data.languageChecks.filter(item => item.checked)
