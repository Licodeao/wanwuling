...
Page({
  ...
  onLoad() {
    this.storeBindings = createStoreBindings(this, {
      ...
      fields: ['userInfo'],
      actions: [
        'updateUserKnowledgeFunAction', 'updateUserKnowledgeSocialAction',
  ...
  navigateToNextPage() {
    ...
    const hasSocialSelected = this.data.socialChecks.some(item => item.checked)
    ...
    const selectedSocial = this.data.socialChecks.filter(item => item.checked)
